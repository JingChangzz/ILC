...
public class ResultManager {
    ...
    public void processResult(boolean writeToDb, String appName, int analysisClassesCount, Writer writer) throws IOException, SQLException {
    ...
    private void analyzeResult(Result result) {
        ...
        while(var3.hasNext()) {
            Map.Entry entry0 = (Map.Entry)var3.next();
                        ...
                        while(var29.hasNext()) {
                            ...
                            while(true) {
                                ...
                                while(undefinedFieldForPath.hasNext()) {
                                    Map.Entry entry = (Map.Entry)undefinedFieldForPath.next();
    ...
    private void insertDynamicReceiverHelper(String permission, String receiverType, BasePropagationValue intentFilters, SootMethod method, Unit unit) throws SQLException {
        ...
        ILCSQLConnection.insertIntentFilters(Collections.singletonList(manifestComponent1));
    }
