 ...
 */
public class SourceInEntryPathTable extends Table {
    private static final String INSERT = "INSERT INTO SourceInEntryPath "
            + "(AppID, trigger_api, source, in_method) VALUES (?, ?, ?, ?)";
